export default class View
{
    ...
    setExitBtn()
    {
        this.clearButtons();
        let elem = document.getElementById('log_reg');
        elem.innerHTML = `<a href="about.html" id="ext1" class="btn btn-outline-danger btn-sm d-block d-md-none">Вийти</a>
        <a href="about.html" id="ext2" class="btn btn-outline-danger btn-md d-none d-md-block">Вийти</a>`;
    }
